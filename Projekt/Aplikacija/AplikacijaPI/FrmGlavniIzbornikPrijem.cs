...
{
    public partial class FrmGlavniIzbornikPrijem : Form
    {
        public FrmGlavniIzbornikPrijem()
        {
            InitializeComponent();
        }
        ...
        {
            FrmPregledRadnihNaloga pregledIzvještaja = new FrmPregledRadnihNaloga();
        ...
        {
            Rad izradaradnognaloga = new Rad();
